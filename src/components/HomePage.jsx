...
//14.- Back to PP, before we call the API, we're going to need an object in this component (that's going to store all of the product information that gets returned from the API -> useState hook)
